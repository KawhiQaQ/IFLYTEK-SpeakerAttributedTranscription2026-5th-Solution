...
try:
    ...
    # ``torch_compilable_check`` was promoted to the public Transformers API
    # after the Qwen3-ASR-compatible 4.57 runtime used by this release.  The
    # MOSS call site passes a scalar condition, so the equivalent eager guard
    # preserves inference behavior without forcing a second Transformers stack.
